      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex md:hidden flex-col items-center text-center space-y-4 pb-8">
          ...
          <div className="flex items-center gap-3 text-xs font-medium text-[#475569] pt-1">
            ...
            <span>•</span>
            <a href="#" className="hover:text-[#0F172A] transition">Twitter</a>
            <span>•</span>
            <a href="#" className="hover:text-[#0F172A] transition">LinkedIn</a>
          </div>
        </div>
        ...
        <div className="hidden md:grid grid-cols-5 gap-8 pb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><a href="#" className="hover:text-[#0F172A] transition">Home</a></li>
              <li><a href="#" className="hover:text-[#0F172A] transition">Technologies</a></li>
              <li><a href="#" className="hover:text-[#0F172A] transition">Projects</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><a href="#" className="hover:text-[#0F172A] transition">Privacy Policy</a></li>
              <li><a href="#" className="hover:text-[#0F172A] transition">Terms of Service</a></li>
            </ul>
          </div>
